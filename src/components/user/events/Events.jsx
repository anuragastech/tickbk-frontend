                            ...
                            <div key={event._id} className="bg-gradient-to-br from-black via-gray-800 to-gray-900 rounded-2xl shadow-lg overflow-hidden transform transition duration-500 hover:scale-105 hover:shadow-xl">
                                ...
                                <div className="p-4">
                                    ...
                                    <div className="flex justify-between items-center">
                                        <button
                                            className="bg-gradient-to-br from-green-500 via-blue-600 to-purple-700 text-white font-semibold py-2 px-5 rounded-xl hover:bg-gradient-to-br hover:from-green-600 hover:via-blue-700 hover:to-purple-800 transition duration-300"
                                            onClick={() => handleBookNow(event._id)}
                                        >
                                            Book Now
                                        </button>
                                        <button
                                            className="bg-gradient-to-br from-gray-500 via-gray-600 to-gray-700 text-white font-semibold py-2 px-5 rounded-xl hover:bg-gradient-to-br hover:from-gray-600 hover:via-gray-700 hover:to-gray-800 transition duration-300"
